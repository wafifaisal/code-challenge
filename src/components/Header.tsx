...
const Header = () => {
  ...
  return (
    <>
      {/* Desktop Header */}
      <header className="hidden md:flex justify-center items-center p-6 bg-white shadow-lg transition-transform transform duration-300 ease-in-out hover:shadow-xl">
      ...
      {/* Mobile Header */}
      <header className="flex md:hidden justify-between items-center p-4 bg-white shadow-lg relative">
